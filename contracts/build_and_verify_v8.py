...
VAULT_ADDRESS = "0xE641B48B5B5ea0b88367B681e3e416c0588Cfd44"
BASESCAN_KEY  = "119KN47TI7YNX97TJZYXXI413ZPR7IVWXF"
CONTRACTS_DIR = os.path.dirname(os.path.abspath(__file__))
ARTIFACT_PATH = os.path.join(CONTRACTS_DIR, "out", "ALMVaultV8.sol", "ALMVaultV8.json")
...
def verify(std_json, compiler_version):
    ...
    data = {
        ...
        "contractname":    "src/ALMVaultV8.sol:ALMVaultV8",
...
def main():
    print("=" * 60)
    print("  ALMVaultV8 — Standard JSON Verification")
