...
# Путь к скомпилированному артефакту
...
def deploy():
    ...
    print(f"Деплой ALM_Airdrop_Beacon с кошелька {account.address}...")
    ...
    # Save the deployed address to a file so the next script can read it
    with open("beacon_address.txt", "w") as f:
