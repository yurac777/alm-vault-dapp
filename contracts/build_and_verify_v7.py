...
VAULT_ADDRESS = "0x80968E24355D449202206FEEA6dB829F2c1CaBCE"
BASESCAN_KEY  = "119KN47TI7YNX97TJZYXXI413ZPR7IVWXF"
CONTRACTS_DIR = os.path.dirname(os.path.abspath(__file__))
ARTIFACT_PATH = os.path.join(CONTRACTS_DIR, "out", "ALMVaultV7.sol", "ALMVaultV7.json")
...
def verify(std_json, compiler_version):
    ...
    data = {
        ...
        "contractname":    "src/ALMVaultV7.sol:ALMVaultV7",
...
def main():
    print("=" * 60)
    print("  ALMVaultV7 — Standard JSON Verification")
